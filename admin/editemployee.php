...
$sql="update tblemployees set FirstName=:fname,LastName=:lname,Address=:address,Reportingauthority=:Reportingauthority,Acceptingauthority=:Acceptingauthority,Phonenumber=:mobileno where id=:eid";
...
<input id="Reportingauthority" name="Reportingauthority" type="text"  value="<?php echo htmlentities($result->Reportingauthority);?>" autocomplete="off" required>
 </div>
   
<div class="input-field col m6 s12">
<label for="Acceptingauthority">Accepting Authority</label>
<input id="Acceptingauthority" name="Acceptingauthority" type="text"  value="<?php echo htmlentities($result->Acceptingauthority);?>" autocomplete="off" required>
</div>
