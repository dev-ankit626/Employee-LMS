...
$sql="INSERT INTO tblemployees(EmpId,FirstName,LastName,EmailId,Password,Gender,Dob,Department,Address,Reportingauthority,Acceptingauthority,Phonenumber,Status) VALUES(:empid,:fname,:lname,:email,:password,:gender,:dob,:department,:address,:Reportingauthority,:Acceptingauthority,:mobileno,:status)";
...
<input id="reportingauthority" name="Reportingauthority" type="text" autocomplete="off" required>
 </div>
   
<div class="input-field col m6 s12">
<label for="acceptingauthority">Accepting Authority</label>
<input id="acceptingauthority" name="Acceptingauthority" type="text" autocomplete="off" required>
</div>
