...
<html lang="en">
    ...
    <body background="backg3.jpg">
        ...
        <div class="mn-content fixed-sidebar">
            <header class="mn-header navbar-fixed #004d40 teal darken-4 navbar1">
                <nav class="#004d40 teal darken-4 navbar1">
                          ...
                          <div class="col s12 m6 l8 offset-l2 offset-m3">
                              <div class="card white darken-1">
                                  ...
                                  <div class="card-content ">
                                      <span class="card-title" align="center"style="font-size:20px;">Employee Login</span>
                                       ...
                                       <div class="row">
                                           ...
                                           <form class="col s12" name="signin" method="post">
                                               ...
                                               <div class="col s12 center-align m-t-sm">
                                                   ...
                                                   <input type="submit" name="signin" value="Log In" class="wave-effect wave-light btn #ff8a65 deep-orange lighten-2">
                                               </div>
                                           </form>
